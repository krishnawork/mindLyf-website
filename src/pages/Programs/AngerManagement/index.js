        ...
        return (
            <Fragment>
                ...
                <div className={isMobile?"width-90m":"width-70m"}>
                    <div style={{fontFamily: 'Nunito-Bold', fontSize: '30px'}}>Anger Management</div>
                    <Row style={{marginTop: '20px'}}>
                        <Col md={8}>
                            <img src={anger} alt="" style={{width: '100%', height: '350px', objectFit: 'cover'}}/>
                        </Col>
                        <Col md={4}>
                    ...
                    <div className="stepsContainer">
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={step1} alt="" style={{width: '100%'}}/></div>
                            <div>
                        ...
                        <div className="gridProgramP" style={{gridTemplateColumns: '1.3fr 1fr'}}>
                            <div>
                                ...
                                <ul className="listProgram">
                                    ...
                                    <li>Find out how to identify your strengths &amp; capabilities</li>
                                </ul>
                            </div>
                            <div><img src={step2} alt="" style={{width: '100%'}}/></div>
                        </div>
                        <div className="curveStyleProgram"><img src={curve2} alt=""/></div>
                        <div className="gridProgramP" style={{gridTemplateColumns: '1fr 1.3fr'}}>
                            <div><img src={step3} alt="" style={{width: '100%'}}/></div>
                            <div>
